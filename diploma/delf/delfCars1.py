...
locations_agg = np.loadtxt('locations_agg.txt')
descriptors_agg = np.loadtxt('descriptors_agg.txt')
accumulated_indexes_boundaries =np.loadtxt('accumulated_indexes_boundaries.txt')


d_tree = cKDTree(descriptors_agg)

query_image = 'cars/query_buildings/q1.jpg'
